...
def get_data_from_source_1():
    sql_stmt = 'SELECT * FROM tra_chanh_gia_tay'
...
def process_data_from_source_1(ti):
    ...
    for index, row in source_data.iterrows():
        query = f"""INSERT INTO public.tra_chanh_gia_tay ("Name", "Gender", "TimeArrived", "TimeAway") VALUES ('{row["Name"]}', '{row["Gender"]}', '{row["TimeArrived"]}', '{row["TimeAway"]}'); """
