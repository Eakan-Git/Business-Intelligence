...
from tcgt_ETL import *

default_args = {
    'owner': 'eakan',
    'start_date': CET,
    # 'email': ['nqtruong.forwork@gmail.com'],
    # 'email_on_failure': ['nqtruong.forwork@gmail.com'],
    'retries': 5,
...
with DAG(
    ...
    task_truncate_stage = PostgresOperator(
        ...
        sql="""
            truncate table tra_chanh_gia_tay
        """
    )
